...
function Banner() {
    ...
    const [total,setTotal]=useState(result+state)
     const addCount=()=>{
         setTotal(Number(result)+Number(total))
     }
     const subCount=()=>{
         setTotal(Number(total)-Number(result))
    ...
    return (
        <div className='container'>
            <div className="items">
                ...
                <input value={result} onChange={(e)=>setResult(e.target.value)} type='text' className='input' id='inputid'/>
            </div><br/>
